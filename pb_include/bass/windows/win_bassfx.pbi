...
Prototype.l BASS_FX_GetVersion()

Prototype.l BASS_FX_TempoCreate(chan.l, flags.l)

;Prototype.l BASS_FX_TempoGetSource(chan.l)

;Prototype.f BASS_FX_TempoGetRateRatio(chan.l)

;Prototype.l BASS_FX_ReverseCreate(chan.l, dec_block.f, flags.l)

;Prototype.l BASS_FX_ReverseGetSource(chan.l)

Prototype.f BASS_FX_BPM_DecodeGet(chan.l, startSec.d, endSec.d, minMaxBPM.l, flags.l, proc.l, user.l)

;Prototype.l BASS_FX_BPM_CallbackSet(Handle.l, proc.l, period.d, minMaxBPM.l, flags.l, user.l)

;Prototype.l BASS_FX_BPM_CallbackReset(Handle.l)

;Prototype.f BASS_FX_BPM_Translate(Handle.l, val2tran.f, trans.l) ; deprecated

;Prototype.l BASS_FX_BPM_Free(Handle.l)

;Prototype.l BASS_FX_BPM_BeatCallbackSet(Handle.l, proc.l, user.l)

;Prototype.l BASS_FX_BPM_BeatCallbackReset(Handle.l)

;Prototype.l BASS_FX_BPM_BeatDecodeGet(Handle.l, startSec.d, endSec.d, flags.l, proc.l, user.l)

;Prototype.l BASS_FX_BPM_BeatSetParameters(Handle.l, bandwidth.f, centerfreq.f, beat_rtime.f)

; Prototype.l BASS_FX_BPM_BeatGetParameters.l(Handle.l, *bandwidth.f, *centerfreq.f, *beat_rtime.f)

;Prototype.l BASS_FX_BPM_BeatGetParameters(Handle.l, *bandwidth.Float, *centerfreq.Float, *beat_rtime.Float)

;Prototype.l BASS_FX_BPM_BeatFree(Handle.l)    
...
; BASS_FX_Load_Library

Threaded _BASS_FX_Load_Library_DLL_.i



Procedure BASS_FX_Free_Library()

	If IsLibrary(_BASS_FX_Load_Library_DLL_)

		CloseLibrary(_BASS_FX_Load_Library_DLL_)
...
Procedure.i BASS_FX_Load_Library(dllpath$)
	...
	_BASS_FX_Load_Library_DLL_ = OpenLibrary(#PB_Any,dllpath$)

	dll = _BASS_FX_Load_Library_DLL_
	...
	GetFunctionProto(dll, BASS_FX_GetVersion)

	If BASS_FX_GetVersion = #Null
	...
	;result = BASS_FX_GetVersion()

	;If (result & $FFFF0000) <> (#BASSFXVERSION & $FFFF0000) Or (result < #BASSFXVERSION)
  ...
  GetFunctionProto(dll, BASS_FX_TempoCreate)

  ;GetFunctionProto(dll, BASS_FX_TempoGetSource)

  ;GetFunctionProto(dll, BASS_FX_TempoGetRateRatio)

  ;GetFunctionProto(dll, BASS_FX_ReverseCreate)

  ;GetFunctionProto(dll, BASS_FX_ReverseGetSource)

  GetFunctionProto(dll, BASS_FX_BPM_DecodeGet)

  ;GetFunctionProto(dll, BASS_FX_BPM_CallbackSet)

  ;GetFunctionProto(dll, BASS_FX_BPM_CallbackReset)

  ;GetFunctionProto(dll, BASS_FX_BPM_Translate)

  ;GetFunctionProto(dll, BASS_FX_BPM_Free)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatCallbackSet)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatCallbackReset)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatDecodeGet)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatSetParameters)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatGetParameters)

  ;GetFunctionProto(dll, BASS_FX_BPM_BeatFree)   	
